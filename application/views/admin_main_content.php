    ...
    <div class="span12">
        ...
        <ul class="chat-box timeline">
            ...
            <li class="arrow-box-left gray">
                <div class="avatar"><img class="avatar-small" src="<?php echo base_url(); ?>resource/images/avatars/avatar1.jpg" /></div>
                <div class="info">
      <span class="name">
        <span class="label label-green">COMMENT</span> <strong class="indent">Janine</strong> posted a comment on this task: <strong>Core Admin</strong>
            ...
            <li class="arrow-box-left gray">
                <div class="avatar"><img class="avatar-small" src="<?php echo base_url(); ?>resource/images/avatars/avatar2.jpg" /></div>
                <div class="info">
      <span class="name">
        <span class="label label-blue">TASK</span> <strong class="indent">John</strong> completed this task: <strong class="strikethrough">Core Admin</strong>
            ...
            <li class="arrow-box-left gray">
                <div class="avatar"><img class="avatar-small" src="<?php echo base_url(); ?>resource/images/avatars/avatar3.jpg" /></div>
                <div class="info">
      <span class="name">
