        ...
        <div class="container-fluid">
            ...
            <div class="nav-collapse nav-collapse-top collapse">
                ...
                <ul class="nav full pull-right">
                  ...
                  <span>
                    <img class="menu-avatar" src="<?php echo base_url(); ?>resource/images/avatars/avatar1.jpg" /> <span><?php echo $username; ?> <i class="icon-caret-down"></i></span>
                    <span class="badge badge-dark-red">5</span>
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="with-image">
                                <div class="avatar">
                                    <img src="<?php echo base_url(); ?>resource/images/avatars/avatar1.jpg" />
                                </div>
                            ...
                            <li><a href="<?php echo base_url('welcome/logout');?>"><i class="icon-off"></i> <span>Logout</span></a></li>
                        </ul>
                    </li>
                </ul>
                ...
                <ul class="nav pull-right">
                    <li class="active"><a href="welcome" title="Go home"><i class="icon-home"></i> Home</a></li>
