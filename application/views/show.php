...
<body>
    <div class="container">
        ...
        <video id="video1" class="video-js vjs-default-skin" width="480" height="320" poster="http://www.tutorial-webdesign.com/wp-content/themes/nurumah/img/logo-bg.png"
            ...
            <source src="http://localhost/video/<?=$video_detail['file_name'];?>" type="video/x-flv">
            <source src="http://localhost/video/<?=$video_detail['file_name'];?>" type='video/mp4'>
            <source src="http://localhost/video/<?=$video_detail['file_name'];?>" type='video/x-msvideo'>
